"""
Modified from https://github.com/r1c7/SlowFastNetworks
"""
import torch
...
def resnet_light(**kwargs):
    """Constructs a Lightweight ResNet model.
    """
    model = SlowFast(Bottleneck, [1, 1, 1, 1], **kwargs)
    return model
